...
init_reverb(int rate, float room_x, float room_y, float listen_x,
	...
	double SPL_LSN_DST = sqrtf(
			(SPL_LSN_XOFS * SPL_LSN_XOFS) + (SPL_LSN_YOFS * SPL_LSN_YOFS));
	...
	double SPR_LSN_DST = sqrtf(
			(SPR_LSN_XOFS * SPR_LSN_XOFS) + (SPR_LSN_YOFS * SPR_LSN_YOFS));
	...
	double dbAirAbs[] = { -0.00044, -0.00131, -0.002728, -0.004665, -0.009887,
			-0.029665 };
	 ...
	 */
	double dbAttn[8][6] = {
			{ -1.839, -6.205, -8.891, -12.059, -15.935, -20.942 }, { -0.131,
					-6.205, -12.059, -20.933, -20.933, -15.944 }, { -0.131,
					-6.205, -12.059, -20.933, -20.933, -15.944 }, { -1.839,
					-6.205, -8.891, -12.059, -15.935, -20.942 }, { -1.839,
					-6.205, -8.891, -12.059, -15.935, -20.942 }, { -0.131,
					-6.205, -12.059, -20.933, -20.933, -15.944 }, { -0.131,
					-6.205, -12.059, -20.933, -20.933, -15.944 }, { -1.839,
					-6.205, -8.891, -12.059, -15.935, -20.942 } };
	/*
...
void do_reverb(struct _rvb *rvb, signed long int *buffer, int size) {
	int i, j, k;
